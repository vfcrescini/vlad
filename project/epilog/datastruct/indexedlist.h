...
int indexedlist_add(indexedlist_type *list, void *data, unsigned int *index, int (*cmp)(void *, void *));
int indexedlist_get_data(indexedlist_type list, void **data, unsigned int index);
int indexedlist_get_index(indexedlist_type list, void *data, unsigned int *index, int (*cmp)(void *, void *));
int indexedlist_del_data(indexedlist_type *list, void *data, int (*cmp)(void *, void *));
