...
\begin{document}
  ...
  \section{Web Server Access Control}
    ...
    \subsection{Integration of PolicyUpdater}
      ...
      \paragraph{\bf Evaluation of HTTP Requests.}
        ...
        \noindent Intuitively, such a tuple may be expressed as a language
        {\cal L} atom:
        ...
        \noindent With language ${\cal L}$ atoms, a query can be generated
        then passed to the core PolicyUpdater system for evaluation:
  ...
  \begin{thebibliography}{5}
    \bibitem{AP}
      ...
      In {\em Apache HTTP Server Version 2.1 Documentation}.
