...
\begin{document}
  ...
  ENDFUNCTION
        ...
        \begin{vverbatim}
  FUNCTION \(Encode_Subst\)(\(grp1\), \(grp2\), \(int\), \(\sigma\), \(tr\))
    CASE type of subset atom OF
      \(subject\) :
        \(offset\) \(=\)
          (\(grp1\) \(\cdot\) \(|T\sb{s}.sg|\) \(\cdot\) \(|T\sb{s}.int|\)) \(+\)
          (\(grp2\) \(\cdot\) \(|T\sb{s}.int|\)) \(+\)
          \(int\)
      \(access right\) :
        \(offset\) \(=\)
          (\(grp1\) \(\cdot\) \(|T\sb{s}.ag|\) \(\cdot\) \(|T\sb{s}.int|\)) \(+\)
          (\(grp2\) \(\cdot\) \(|T\sb{s}.int|\)) \(+\)
          (\(|T\sb{s}.sg|\sp{2}\) \(\cdot\) \(|T\sb{s}.int|\)) \(+\)
          \(int\)
      \(object\) :
        \(offset\) \(=\)
          (\(grp1\) \(\cdot\) \(|T\sb{s}.og|\) \(\cdot\) \(|T\sb{s}.int|\)) \(+\)
          (\(grp2\) \(\cdot\) \(|T\sb{s}.int|\)) \(+\)
          (\(|T\sb{s}.sg|\sp{2}\) \(\cdot\) \(|T\sb{s}.int|\)) \(+\)
