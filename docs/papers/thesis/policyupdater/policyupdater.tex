...
ENDFUNCTION
          ...
          \begin{itemize}
            ...
            \item
              $RuleHead$($\alpha$, $\tau$) generates the consequent of the
              rule. $\alpha$ is a numeric representation of an atom (e.g.
              returned by the $Encode$() function) and $\tau$ is either $T$ or
              $F$, indicating whether the atom is positive or negative
              (negation-as-failure).
            \item
              $RuleBody$($\alpha$, $\tau$) generates the premise of the rule.
              The parameters of this function is the same as that of the
              function $RuleHead$().
            \item
  ...
  FOR \(i\) = \(0\) TO \(Len\)(\(Tq\)) DO
    FOR \(j\) = \(0\) TO \(Len\)(\(Tc\)) DO
      ...
      FOR \(k\) = \(0\) TO \(Len\)(\(Tc\)[\(j\)].\(exp\)) DO
        ...
        \(RuleHead\)(\(a\), \(true\))
      ENDDO
      FOR \(k\) = \(0\) TO \(Len\)(\(Tc\)[\(j\)].\(pcnd\)) DO
        \(a\) = \(Encode\)(\(Tc\)[\(j\)].\(pcnd\)[\(k\)].\(atm\), \(i\), \(Tc\)[\(j\)].\(pcnd\)[\(k\)].\(tr\))
        \(RuleBody\)(\(a\), \(true\))
      ENDDO
      FOR \(k\) = \(0\) TO \(Len\)(\(Tc\)[\(j\)].\(ncnd\)) DO
...
FUNCTION \(GenSubSubstInherRules\)(\(Ts\), \(Tq\))
  FOR \(i\) = \(0\) TO \(Len\)(\(Tq\)) DO
    FOR \(j\) = \(0\) TO \(Len\)(\(Ts\).\(sg\)) DO
      FOR \(k\) = \(0\) TO \(Len\)(\(Ts\).\(sg\)) DO
        IF \(Ts\).\(sg\)[\(j\)] != \(Ts\).\(sg\)[\(k\)] THEN
          FOR \(l\) = \(0\) TO \(Len\)(\(Ts\).\(a\)) DO
            FOR \(m\) = \(0\) TO \(Len\)(\(Ts\).\(o\)) DO
              \(RuleBegin\)()
              \(h\_atm\) = \{\(Ts\).\(sg\)[\(j\)], \(Ts\).\(ag\)[\(l\)], \(Ts\).\(og\)[\(m\)]\}
              \(RuleHead\)(\(Encode\)(\(h\_atm\), \(i\), \(true\)), \(true\))
              ...
              \(RuleBegin\)()
              \(h\_atm\) = \{\(Ts\).\(sg\)[\(j\)], \(Ts\).\(ag\)[\(l\)], \(Ts\).\(og\)[\(m\)]\}
              \(RuleHead\)(\(Encode\)(\(h\_atm\), \(i\), \(false\)), \(true\))
              \(h\_atm\) = \{\(Ts\).\(sg\)[\(k\)], \(Ts\).\(ag\)[\(l\)], \(Ts\).\(og\)[\(m\)]\}
...
FUNCTION \(GenSubTransRules\)(\(Ts\), \(Tq\))
  FOR \(i\) = \(0\) TO \(Len\)(\(Tq\)) DO
    FOR \(j\) = \(0\) TO \(Len\)(\(Ts\).\(sg\)) DO
      FOR \(k\) = \(0\) TO \(Len\)(\(Ts\).\(sg\)) DO
        FOR \(l\) = \(0\) TO \(Len\)(\(Ts\).\(sg\)) DO
          IF \(j\) != \(k\) AND \(j\) != \(l\) AND \(k\) != \(l\) THEN
            RuleBegin()
            \(s\_atm\) = \{\(Ts\).\(sg\)[\(j\)], \(Ts\).\(sg\)[\(l\)]\}
            \(RuleHead\)(\(Encode\)(\(s\_atm\), \(i\), \(true\)), \(true\))
            \(s\_atm\) = \{\(Ts\).\(sg\)[\(j\)], \(Ts\).\(sg\)[\(k\)]\}
            \(RuleBody\)(\(Encode\)(\(s\_atm\), \(i\), \(true\)), \(true\))
    ...
    FOR \(j\) = \(0\) TO \(Len\)(\(Ts\).\(s\)) DO
      FOR \(k\) = \(0\) TO \(Len\)(\(Ts\).\(a\)) DO
        FOR \(l\) = \(0\) TO \(Len\)(\(Ts\).\(o\)) DO
          ...
          \(RuleBegin\)()
          \(RuleHead\)(\(Encode\)(\(h\_atm\), \(i\) \(+\) \(1\), \(true\)), \(true\))
          \(RuleBody\)(\(Encode\)(\(h\_atm\), \(i\), \(true\)), \(true\))
          \(RuleBody\)(\(Encode\)(\(h\_atm\), \(i\) \(+\) \(1\), \(false\)), \(false\))
          \(RuleEnd\)()
          \(RuleBegin\)()
          \(RuleHead\)(\(Encode\)(\(h\_atm\), \(i\) \(+\) \(1\), \(false\)), \(true\))
          \(RuleBody\)(\(Encode\)(\(h\_atm\), \(i\), \(false\)), \(true\))
    ...
    \section{Allen's Temporal Interval Algebra}
      ...
      \subsection{Inferring New Relations}
        ...
        \subsubsection{Propagation Algorithm}
          ...
          \begin{valgorithm}[tbhp]{$Trans_{2}()$}{algo-tempo-trns2}
      ...
      \subsection{Translation to Normal Logic Program}
        ...
        \subsubsection{Encode() Function Revisited}
          ...
          \begin{vquote}
            ...
            $1$ $=$ $Encode$($holds$($alice$, $exec$, $file$, $today$), $S_1$, $true$)

            $2$ $=$ $Encode$($holds$($alice$, $exec$, $file$, $today$), $S_1$, $false$)
          \end{vquote}
...
ENDFUNCTION
        ...
        \begin{valgorithm}[tbhp]{$Decode\_Holds$()}{algo-implndecho}
FUNCTION \(Decode_Holds\)(\(id\), \(\sigma\), \(tr\))
  \(s\) \(=\) \(id\) div ((\(|\)\(\theta\).\(as\)\(|\) \(+\) \(|\)\(\theta\).\(ag\)\(|\)) \(\cdot\) (\(|\)\(\theta\).\(os\)\(|\) \(+\) \(|\)\(\theta\).\(og\)\(|\)) \(\cdot\) \(|\)\(\theta\).\(int\)\(|\))
  \(id\) \(=\) \(id\) mod ((\(|\)\(\theta\).\(as\)\(|\) \(+\) \(|\)\(\theta\).\(ag\)\(|\)) \(\cdot\) (\(|\)\(\theta\).\(os\)\(|\) \(+\) \(|\)\(\theta\).\(og\)\(|\)) \(\cdot\) \(|\)\(\theta\).\(int\)\(|\))
  \(a\) \(=\) \(id\) div ((\(|\)\(\theta\).\(os\)\(|\) \(+\) \(|\)\(\theta\).\(og\)\(|\)) \(\cdot\) \(|\)\(\theta\).\(int\)\(|\))
  \(id\) \(=\) \(id\) mod ((\(|\)\(\theta\).\(os\)\(|\) \(+\) \(|\)\(\theta\).\(og\)\(|\)) \(\cdot\) \(|\)\(\theta\).\(int\)\(|\))
  \(o\) \(=\) \(id\) div \(|\)\(\theta\).\(int\)\(|\)
  \(i\) \(=\) \(id\) mod \(|\)\(\theta\).\(int\)\(|\)

  IF \(s\) \(\geq\) \(|\)\(\theta\).\(ss\)\(|\) THEN
    \(sub\) = \(T\sb{s}.sg\)[\(s\) \(-\) \(|\)\(\theta\).\(ss\)\(|\)]
  ELSE
    \(sub\) = \(T\sb{s}.ss\)[\(s\)]
  ENDIF
  IF \(a\) \(\geq\) \(|\)\(\theta\).\(as\)\(|\) THEN
    \(acc\) = \(T\sb{s}.ag\)[\(a\) \(-\) \(|\)\(\theta\).\(as\)\(|\)]
  ELSE
    \(acc\) = \(T\sb{s}.as\)[\(a\)]
  ENDIF
  IF \(o\) \(\geq\) \(|\)\(\theta\).\(os\)\(|\) THEN
    \(obj\) = \(T\sb{s}.og\)[\(o\) \(-\) \(|\)\(\theta\).\(os\)\(|\)]
  ELSE
    \(obj\) = \(T\sb{s}.os\)[\(o\)]
  ENDIF
...
ENDFUNCTION
        ...
        \begin{valgorithm}[tbhp]{$Decode\_Memb$()}{algo-impln-decme}
FUNCTION \(Decode_Memb\)(\(id\), \(\sigma\), \(tr\))
  \(c\sb{0}\) \(=\) (\(|\)\(\theta\).\(ss\)\(|\) \(\cdot\) \(|\)\(\theta\).\(sg\)\(|\) \(\cdot\) \(|\)\(\theta\).\(int\)\(|\)) 
  \(c\sb{1}\) \(=\) \(c\sb{0}\) \(+\) (\(|\)\(\theta\).\(as\)\(|\) \(\cdot\) \(|\)\(\theta\).\(ag\)\(|\) \(\cdot\) \(|\)\(\theta\).\(int\)\(|\)) 

  IF \(id\) \(<\) \(c\sb{0}\) THEN
    \(elt\) \(=\) \(T\sb{s}.ss\)[\(id\) div (\(|\)\(\theta\).\(sg\)\(|\) \(\cdot\) \(|\)\(\theta\).\(int\)\(|\))]
    \(grp\) \(=\) \(T\sb{s}.sg\)[(\(id\) mod (\(|\)\(\theta\).\(sg\)\(|\) \(\cdot\) \(|\)\(\theta\).\(int\)\(|\))) div \(|\)\(\theta\).\(int\)\(|\)]
    \(int\) \(=\) \(T\sb{s}.int\)[(\(id\) mod (\(|\)\(\theta\).\(sg\)\(|\) \(\cdot\) \(|\)\(\theta\).\(int\)\(|\))) mod \(|\)\(\theta\).\(int\)\(|\)]
  ELSE IF \(id\) \(<\) \(c\sb{1}\) THEN
    \(id\) \(=\) \(id\) \(-\) \(c\sb{0}\)

    \(elt\) \(=\) \(T\sb{s}.as\)[\(id\) div (\(|\)\(\theta\).\(ag\)\(|\) \(\cdot\) \(|\)\(\theta\).\(int\)\(|\))]
    \(grp\) \(=\) \(T\sb{s}.ag\)[(\(id\) mod (\(|\)\(\theta\).\(ag\)\(|\) \(\cdot\) \(|\)\(\theta\).\(int\)\(|\))) div \(|\)\(\theta\).\(int\)\(|\)]
    \(int\) \(=\) \(T\sb{s}.int\)[(\(id\) mod (\(|\)\(\theta\).\(ag\)\(|\) \(\cdot\) \(|\)\(\theta\).\(int\)\(|\))) mod \(|\)\(\theta\).\(int\)\(|\)]
  ELSE
    \(id\) \(=\) \(id\) \(-\) \(c\sb{1}\)

    \(elt\) \(=\) \(T\sb{s}.os\)[\(id\) div (\(|\)\(\theta\).\(og\)\(|\) \(\cdot\) \(|\)\(\theta\).\(int\)\(|\))]
    \(grp\) \(=\) \(T\sb{s}.og\)[(\(id\) mod (\(|T\sb{s}og|\) \(\cdot\) \(|\)\(\theta\).\(int\)\(|\))) div \(|\)\(\theta\).\(int\)\(|\)]
    \(int\) \(=\) \(T\sb{s}.int\)[(\(id\) mod (\(|\)\(\theta\).\(og\)\(|\) \(\cdot\) \(|\)\(\theta\).\(int\)\(|\))) mod \(|\)\(\theta\).\(int\)\(|\)]
  ENDIF
...
ENDFUNCTION
        ...
        \begin{valgorithm}[tbhp]{$Decode\_Subst$()}{algo-impln-decsu}
FUNCTION \(Decode_Subst\)(\(id\), \(\sigma\), \(tr\))
  \(c\sb{0}\) \(=\) (\(|\)\(\theta\).\(sg\)\(|\sp{2}\) \(\cdot\) \(|\)\(\theta\).\(int\)\(|\)) 
  \(c\sb{1}\) \(=\) \(c\sb{0}\) \(+\) (\(|\)\(\theta\).\(ag\)\(|\sp{2}\) \(\cdot\) \(|\)\(\theta\).\(int\)\(|\)) 

  IF \(id\) \(<\) \(c\sb{0}\) THEN
    \(grp\sb{0}\) \(=\) \(T\sb{s}.sg\)[\(id\) div (\(|\)\(\theta\).\(sg\)\(|\) \(\cdot\) \(|\)\(\theta\).\(int\)\(|\))]
    \(grp\sb{1}\) \(=\) \(T\sb{s}.sg\)[(\(id\) mod (\(|\)\(\theta\).\(sg\)\(|\) \(\cdot\) \(|\)\(\theta\).\(int\)\(|\))) div \(|\)\(\theta\).\(int\)\(|\)]
    \(int\) \(=\) \(T\sb{s}.int\)[(\(id\) mod (\(|\)\(\theta\).\(sg\)\(|\) \(\cdot\) \(|\)\(\theta\).\(int\)\(|\))) mod \(|\)\(\theta\).\(int\)\(|\)]
  ELSE IF \(id\) \(<\) \(c\sb{1}\) THEN
    \(id\) \(=\) \(id\) \(-\) \(c\sb{0}\)

    \(grp\sb{0}\) \(=\) \(T\sb{s}.ag\)[\(id\) div (\(|\)\(\theta\).\(ag\)\(|\) \(\cdot\) \(|\)\(\theta\).\(int\)\(|\))]
    \(grp\sb{1}\) \(=\) \(T\sb{s}.ag\)[(\(id\) mod (\(|\)\(\theta\).\(ag\)\(|\) \(\cdot\) \(|\)\(\theta\).\(int\)\(|\))) div \(|\)\(\theta\).\(int\)\(|\)]
    \(int\) \(=\) \(T\sb{s}.int\)[(\(id\) mod (\(|\)\(\theta\).\(ag\)\(|\) \(\cdot\) \(|\)\(\theta\).\(int\)\(|\))) mod \(|\)\(\theta\).\(int\)\(|\)]
  ELSE
    \(id\) \(=\) \(id\) \(-\) \(c\sb{1}\)

    \(grp\sb{0}\) \(=\) \(T\sb{s}.os\)[\(id\) div (\(|\)\(\theta\).\(og\)\(|\) \(\cdot\) \(|\)\(\theta\).\(int\)\(|\))]
    \(grp\sb{1}\) \(=\) \(T\sb{s}.og\)[(\(id\) mod (\(|T\sb{s}og|\) \(\cdot\) \(|\)\(\theta\).\(int\)\(|\))) div \(|\)\(\theta\).\(int\)\(|\)]
    \(int\) \(=\) \(T\sb{s}.int\)[(\(id\) mod (\(|\)\(\theta\).\(og\)\(|\) \(\cdot\) \(|\)\(\theta\).\(int\)\(|\))) mod \(|\)\(\theta\).\(int\)\(|\)]
  ENDIF
...
ENDFUNCTION
        ...
        \begin{valgorithm}[tbhp]{$Decode\_Fact$()}{algo-impln-decfa}
