...
\begin{document}
  ...
  relation equals(i0, i1);
      ...
      algorithm. Furthermore, several methods (e.g. \cite{LA,VB}) for full
      network consistency checking already exist. In this work, we make the
      assumption that 3-consistency is sufficient for our authorisation system
      as we have observed that this covers all scenarios we have examined.
