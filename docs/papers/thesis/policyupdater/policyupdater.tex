  ...
  FOR \(i\) = \(0\) TO \(|\theta|\) DO
    FOR \(j\) = \(0\) TO \(|\omega\sb{c}|\) DO
      ...
      FOR \(k\) = \(0\) TO \(|\)\(\omega\sb{c}\)[\(j\)].\(exp\)\(|\) DO
        ...
        \(RuleHead\)(\(\alpha\))
      ENDDO
      FOR \(k\) = \(0\) TO \(|\)\(\omega\sb{c}\)[\(j\)].\(pcnd\)\(|\) DO
        \(\alpha\) = \(Encode\)(\(\omega\sb{c}\)[\(j\)].\(pcnd\)[\(k\)].\(atm\), \(i\), \(\omega\sb{c}\)[\(j\)].\(pcnd\)[\(k\)].\(tr\))
        \(RuleBody\)(\(\alpha\), \(true\))
      ENDDO
      FOR \(k\) = \(0\) TO \(|\)\(\omega\sb{c}\)[\(j\)].\(ncnd\)\(|\) DO
        \(\alpha\) = \(Encode\)(\(\omega\sb{c}\)[\(j\)].\(ncnd\)[\(k\)].\(atm\), \(i\), \(\omega\sb{c}\)[\(j\)].\(ncnd\)[\(k\)].\(tr\))
  ...
  FOR \(i\) = \(0\) TO \(|\psi|\) DO
    FOR \(j\) = \(0\) TO \(|\omega\sb{u}|\) DO
      IF \(\psi\)[\(i\)].\(name\) == \(\omega\sb{u}\)[\(j\)].\(name\) THEN
        \(e\) = \(GndUpdate\)(\(\omega\sb{u}\)[\(j\)], \(\psi\)[\(i\)].\(ilist\))
        \(RuleBegin\)()
        FOR \(k\) = \(0\) TO \(|\)\(e\).\(pst\)\(|\) DO
          \(\alpha\) = \(Encode\)(\(e\).\(pst\)[\(k\)].\(atm\), \(i\) + \(1\), \(e\).\(pst\)[\(k\)].\(tr\))
          \(RuleHead\)(\(\alpha\))
        ENDDO
        FOR \(k\) = \(0\) TO \(|\)\(e\).\(pre\)\(|\) DO
          \(\alpha\) = \(Encode\)(\(e\).\(pre\)[\(k\)].\(atm\), \(i\), \(e\).\(pre\)[\(k\)].\(tr\))
          \(RuleBody\)(\(\alpha\), \(true\))
        ENDDO
        \(RuleEnd\)()
      ENDIF
...
FUNCTION \(IsFactIn\)(\(\varrho\), \(\Lambda\))
  FOR \(i\) = \(0\) TO \(|\Lambda|\) DO
    IF NOT \(\Lambda\)[\(i\)].\(is\_in\)(\(\varrho\)) THEN
      RETURN \(false\)
    ENDIF
  ENDDO
  RETURN \(true\)
...
ENDFUNCTION
  ...
  relation \(\alpha\sb{0}\), \(\ldots\), \(\alpha\sb{n}\);
            ...
            Now, we define a function $Normalise$($\epsilon$) that takes
  ...
  \(NET.Add\)(\({\iota}0\sb{i}\), \({\iota}1\sb{i}\), \(rs\sb{i}\))
	    ...
	    language ${\cal L^T}$ expressions containing entity or interval
            ...
            \begin{vquote}
              ...
              \hspace{1em}
              $\epsilon'$ $=$
              $Normalise$($Replace$($\epsilon$, $V$, $t_i$)),
...
ENDFUNCTION
        ...
        \subsubsection{Extending GenNLP()}
          ...
          structure; $\theta$, the symbol table; and $\psi$, the policy
          update sequence table. These parameters are passed to the three
          functions that generate the three types of temporal rules which
          correspond to the three atom types.
...
FUNCTION \(GenTempoRules\)(\(NET\), \(\theta\), \(\psi\))
  \(GenHldsTempoRules\)(\(NET\), \(\theta\), \(\psi\))
  \(GenMembTempoRules\)(\(NET\), \(\theta\), \(\psi\))
  \(GenSubsTempoRules\)(\(NET\), \(\theta\), \(\psi\))
ENDFUNCTION
          \end{valgorithm}

          \begin{valgorithm}[tbhp]{GenHldsTempoRules()}{algo-impln-ghdtr}
FUNCTION \(GenHldsTempoRules\)(\(NET\), \(\theta\), \(\psi\))
  FOR \(i\) = \(0\) TO \(|\psi|\) DO
    FOR \(j\) = \(0\) TO \(|\)\(\theta\).\(s\)\(|\) DO
      FOR \(k\) = \(0\) TO \(|\)\(\theta\).\(a\)\(|\) DO
        FOR \(l\) = \(0\) TO \(|\)\(\theta\).\(o\)\(|\) DO
