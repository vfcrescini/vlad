...
\begin{document}
  ...
  \addcontentsline{toc}{chapter}{Acknowledgements}
    ...
    grateful. My gratitude also goes to Dr. Yun Bai, whose previous work on
  ...
  \addcontentsline{toc}{chapter}{Abstract}
    ...
    from accessing the protected information. In a typical information system,
    ...
    \section{Literature Review}
      ...
      \subsection{Logic-Based Approach}
        ...
        \end{vquote}
         ...
         The rules are evaluated into a policy base. In this approach, the
         ...
         expressing authorisation policies. Example \ref{exam-intro-wooex} shows
         ...
         respective access control mechanism implementations \cite{CAS}
         ...
         the policy reasoning mechanism by restricting the expressiveness of the
...
ENDFUNCTION
  ...
  \chapter{Conclusion}
    ...
    conservative discipline is sufficiently safe for most applications, other
