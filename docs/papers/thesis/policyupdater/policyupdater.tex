  ...
  \chapter{Introduction}
    ...
    \section{Key Issues}
      ...
      \subsection{Implementation}
        ...
        Efficiency is particularly important since a typical authorisation
        system policy is composed of a huge number of rules and each
        authorisation request usually requires instant response.
