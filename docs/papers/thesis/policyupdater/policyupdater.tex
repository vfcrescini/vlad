        ...
        IF \(Ts\).\(sg\)[\(j\)] != \(Ts\).\(sg\)[\(k\)] THEN
          FOR \(l\) = \(0\) TO \(Len\)(\(Ts\).\(a\)) DO
            FOR \(m\) = \(0\) TO \(Len\)(\(Ts\).\(o\)) DO
              ...
              \(RuleHead\)(\(Encode\)(\(h\_atm\), \(i\), \(T\)), \(T\))
              \(h\_atm\) = \{\(Ts\).\(sg\)[\(k\)], \(Ts\).\(ag\)[\(l\)], \(Ts\).\(og\)[\(m\)]\}
              \(RuleBody\)(\(Encode\)(\(h\_atm\), \(i\), \(T\)), \(T\))
              \(s\_atm\) = \{\(Ts\).\(sg\)[\(j\)], \(Ts\).\(sg\)[\(k\)]\}
              \(RuleBody\)(\(Encode\)(\(s\_atm\), \(i\), \(T\)), \(T\))
              \(h\_atm\) = \{\(Ts\).\(sg\)[\(j\)], \(Ts\).\(ag\)[\(l\)], \(Ts\).\(og\)[\(m\)]\}
              \(RuleBody\)(\(Encode\)(\(h\_atm\), \(i\), \(F\)), \(F\))
              \(RuleEnd\)()
              \(RuleBegin\)()
              \(h\_atm\) = \{\(Ts\).\(sg\)[\(j\)], \(Ts\).\(ag\)[\(l\)], \(Ts\).\(og\)[\(m\)]\}
              \(RuleHead\)(\(Encode\)(\(h\_atm\), \(i\), \(F\)), \(T\))
              \(h\_atm\) = \{\(Ts\).\(sg\)[\(k\)], \(Ts\).\(ag\)[\(l\)], \(Ts\).\(og\)[\(m\)]\}
              \(RuleBody\)(\(Encode\)(\(h\_atm\), \(i\), \(F\)), \(T\))
              \(s\_atm\) = \{\(Ts\).\(sg\)[\(j\)], \(Ts\).\(sg\)[\(k\)]\}
              \(RuleBody\)(\(Encode\)(\(s\_atm\), \(i\), \(T\)), \(T\))
              \(RuleEnd\)()
            ENDDO
    ...
    FOR \(j\) = \(0\) TO \(Len\)(\(Ts\).\(s\)) DO
      FOR \(k\) = \(0\) TO \(Len\)(\(Ts\).\(a\)) DO
        FOR \(l\) = \(0\) TO \(Len\)(\(Ts\).\(o\)) DO
          ...
          \(RuleBegin\)()
          \(RuleHead\)(\(Encode\)(\(h\_atm\), \(i\) \(+\) \(1\), \(T\)), \(T\))
          \(RuleBody\)(\(Encode\)(\(h\_atm\), \(i\), \(T\)), \(T\))
          \(RuleBody\)(\(Encode\)(\(h\_atm\), \(i\) \(+\) \(1\), \(F\)), \(F\))
          \(RuleEnd\)()
          \(RuleBegin\)()
          \(RuleHead\)(\(Encode\)(\(h\_atm\), \(i\) \(+\) \(1\), \(F\)), \(T\))
          \(RuleBody\)(\(Encode\)(\(h\_atm\), \(i\), \(F\)), \(T\))
          \(RuleBody\)(\(Encode\)(\(h\_atm\), \(i\) \(+\) \(1\), \(T\)), \(F\))
          \(RuleEnd\)()
        ENDDO
      ENDDO
    ENDDO
    ...
    \section{Authorisation Engine}
      ...
      \subsection{Translation to Normal Logic Program}
        ...
        \subsubsection{Encode() Function Revisited}
          ...
          required to achieve and maintain this consistent mapping. Table XXX
          shows a conceptual systematic arrangement of facts using the
          symbol table $\theta$ discussed in XXX.
