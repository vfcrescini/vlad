...
\begin{document}
  ...
  \chapter{Introduction}
    ...
    \section{General Background}
      ...
      control is ofter used interchangeably with the term authorisation.
    ...
    \section{Literature Review}
      ...
      \subsection{Role-Based Access Control}
        ...
        \cite{FER1,FER2}, then later, a full RBAC framework in \cite{SAN}.
      ...
      \subsection{Logic-Based Access Control}
        ...
        language. In this language, an atom is 3-tuple ($s$, $a$, $o$)
        representing a binding of a subject $s$, an access right $a$ and an 
        object $o$. A simplified syntax of the language rule is shown below:
        ...
        \end{vquote}
         ...
         where the absence of proof may be used as a prerequisite for a rule.

         The rules are evaulated into a policy base. In this approach, the
         policy base is defined as a 4-tuple: ($P^+$, $P^-$, $N^+$, $N^-$)
         where each component is a set of atoms. $P^+$ contains a set of atoms
         that explicitly grant authorisations. For example, to evaluate
         whether subject $s$ is given access right $a$ to object $o$, one must
         check whether ($s$, $a$, $o$) $\in$ $P^+$ is true. $N^+$ contains a
         set of atoms that explicitly deny authorisations. $P^-$ and $N^-$
         records authorisations that should not be explicitly granted or
         denied, respectively.
