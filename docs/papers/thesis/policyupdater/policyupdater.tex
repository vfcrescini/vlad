...
\begin{document}
  ...
  \(NET.Add\)(\(Normalise\)(\(\varepsilon\)))
	      ...
	      language ${\cal L^T}$ expression $\varepsilon$ and a set of
              ...
              {\em where} clause with an interval expression $\epsilon$ and a
              set $V$ of variables that occurr in $\epsilon$, a set $T$ of
              interval tuples is said to satisfy $\epsilon$ if and only if each
              tuple $t$ $\in$ $T$ in the form \{${\iota}_0$, \ldots,
