...
ENDFUNCTION
          ...
          \begin{itemize}
            ...
            \item
              ...
              returned by the $Encode$() function) and $\tau$ is either $true$
              or $false$, indicating whether the atom is positive or negative
              (negation-as-failure).
            \item
...
FUNCTION \(TransInitStateRules\)(\(Ti\))
  FOR \(i\) = \(0\) TO \(|Ti|\) DO
    \(RuleBegin\)()
    \(RuleHead\)(\(Encode\)(\(Ti\)[\(i\)].\(atm\), \(0\), \(Ti\)[\(i\)].\(tr\)), \(true\))
    \(RuleBody\)(\(true\), \(true\))
    \(RuleEnd\)()
  ENDDO
ENDFUNCTION
          ...
          FOR \(m\) = \(0\) TO \(|\)\(Ts\).\(int\)\(|\) DO
            FOR \(n\) = \(0\) TO \(|\)\(Ts\).\(int\)\(|\) DO
              ...
              IF (\(rs\) | \(101\)) == \(101\) THEN
                ...
                \(RuleBegin\)()
                \(RuleHead\)(\(Encode\)(\(a\), \(i\), \(true\)), \(true\))
                \(RuleBody\)(\(Encode\)(\(b\), \(i\), \(true\)), \(true\))
                \(RuleEnd\)()
                \(RuleBegin\)()
                \(RuleHead\)(\(Encode\)(\(a\), \(i\), \(false\)), \(true\))
