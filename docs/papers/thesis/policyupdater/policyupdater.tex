...
ENDFUNCTION
  ...
  relation equals(i0, i1);
      ...
      consistency checking, like those in \cite{LAD,VA2} already exist. In this
    ...
    \section{Temporal Reasoner}
      ...
      \subsection{Network Structure}
        ...
        \subsubsection{Binary Representation of Relation Sets}
          ...
          \footnotetext{A similar method is used in \cite{VA2, VIL}.}
...
ENDFUNCTION
      ...
      \subsection{Network Operators}
        ...
        \begin{vdefinition}
          ...
          The following shows the full operator set of an interval relation
          network $NET$:
...
ENDFUNCTION
        ...
        propagated makes no difference in the resulting network \cite{MAC,VAN}.
...
ENDFUNCTION
        ...
        yield new information \cite{VA2}. These combinations are summarised in
