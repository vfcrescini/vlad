    ...
    \section{Temporal Reasoner}
      ...
      \subsection{Network Structure}
        ...
        \subsubsection{Network Data Structure}
          ...
          For example, Figure \ref{figu-impln-nws02} shows a network $NET$
          containing only the relations $before$($\iota_0$, $\iota_1$) and
          $during$($\iota_0$, $\iota_1$) are stored in the following manner:
