...
ENDFUNCTION
  ...
  \chapter{Conclusion}
    ...
    have been proposed and used over the years, very few maintains a good
    ...
    rules. Through the use of this language, the PolicyUpdater system is
    capable of expressing and evaluating both positive and negative
    authorisations from policies with conditional logic rules. The two key
    features of this language, and therefore the system, is its ability to
    express default authorisations in conditional rules and conditional policy
    update rules which can be applied in sequence.
