...
\begin{document}
  ...
  \chapter{Introduction}
    ...
    \section{Literature Review}
      ...
      \subsection{Logic-Based Approach}
        ...
        \end{vquote}
         ...
         policy language. However, although the use of first-order logic
         provides sufficient expressive power for most applications, this
         tradeoff means that this approach cannot handle default propositions
         or policy updates.
       ...
       \subsection{Other Approaches and Considerations}
         ...
         authorisations to be bound by to a specific time period, or hold only
    ...
    \section{About the Thesis}
      ...
      outlines full implementation details of a temporal interval relation
      ...
      journals and conference papers \cite{CRE1,CRE2,CRE3} and a paper on the
      extended PolicyUpdater system \cite{CRE4} will be submitted soon.
  ...
  \chapter{PolicyUpdater System}
    ...
    \footnotetext{
      Implementation and performance analysis was published in \cite{CRE1}. The
      web server module was first introduced in \cite{CRE3}.
    }
...
<alphanum>               : <alpha> |
  ...
  \begin{thebibliography}{III}
    ...
    \bibitem{BAI2}
      ...
      In {\em Proceedings of Safety, Reliability and Security of Computer Systems (LNCS)},
      Vol. 1698, pp. 375-384,
      1999.
    ...
    \bibitem{CRE4}
      Crescini V. F., Zhang Y.,
      Extending the PolicyUpdater System with Temporal Constraints.
      (to be submitted),
      2006.
