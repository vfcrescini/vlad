      ...
      \subsection{Data Structures}
        ...
        \subsubsection{Policy Base}
          ...
          \paragraph{Atoms.}
            ...
            The three types of atoms ({\em holds}, {\em membership} and
            {\em subset}) are represented as structures of 2 to 3 strings,
            with each string matching an entity identifier from the
            symbol table. Table \ref{tabl-polup-atdsr} shows the fields
            associated with each atom type.
            ...
            \begin{table}[tbhp]
              \begin{center}
                \begin{tabular}[t]{|l|l|l|l|}
                  ...
                  \hline                                                     
                  {\multirow{2}{*}{subset}} & $grp_0$        & string        & subgroup entity \\
                  \cline{2-4}                                                
...
ENDFUNCTION
    ...
    \section{Authorisation Engine}
      ...
      \subsection{Translation to Normal Logic Program}
        ...
        \begin{valgorithm}[tbhp]{Encode\_Holds()}{algo-impln-encho}
...
ENDFUNCTION
        ...
        \begin{valgorithm}[tbhp]{Encode\_Memb()}{algo-impln-encme}
...
ENDFUNCTION
        ...
        \begin{valgorithm}[tbhp]{Encode\_Subst()}{algo-impln-encsu}
