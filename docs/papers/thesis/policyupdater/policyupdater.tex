...
\begin{document}
  ...
  grant\_write()
    ...
    \section{Domain Consistency and Query Evaluation}
      ...
      \ref{def-langl-trans}, we define consistency as follows:
  ...
  update \(u\)()
    ...
    if \(\rho\sb{10\sb{0}}\), \(\ldots\), \(\rho\sb{10\sb{n\sb{10}}}\), \(!\)\(\rho\sb{11\sb{0}}\), \(\ldots\), \(!\)\(\rho\sb{11\sb{n\sb{11}}}\);
      ...
      \begin{vproof}
        From Definition \ref{def-cons}, given a normal domain description
        ...
        ${\cal D}_{\cal L}$, as defined by Definition \ref{def-norm}, will
        generate an extended logic program $Trans$(${\cal D}_{\cal L}$)
        ...
        rules of the following form do not occur in
        $Trans$(${\cal D}_{\cal L}$):
      ...
      user queries, Theorem \ref{the-cons} may be used to check whether a
      domain description is consistent.
      ...
      Definition \ref{def-eval} shows that given a finite list of policy
      updates $\psi$, a query expression $\phi$ may be evaluated from a
      ...
      \begin{vexample}
        \label{ex-2}
        Given the language ${\cal L}$ code listing in Example \ref{ex-2-1} and
        its translation in Example \ref{ex-2-2}, where the update sequence list
...
ENDFUNCTION
  ...
  update \(u\)()
    ...
    if \(\rho\sb{10\sb{0}}\), \(\ldots\), \(\rho\sb{10\sb{n\sb{10}}}\), \(!\)\(\rho\sb{11\sb{0}}\), \(\ldots\), \(!\)\(\rho\sb{11\sb{n\sb{11}}}\);
      ...
      fact, Valdez-Perez \cite{VAL} generalised these conditions where an
  ...
  relation equals(i0, i1);
      ...
      \cite{ALE}, shown in Figure \ref{fig-net-ex-07}.
