          ...
          \begin{vdefinition}
            ...
            \begin{itemize}
              ...
              \item
                ...
                the relation set $RS$.
              \item
                The $NET.AddRel$($I_0$, $I_1$, $RS$) operator adds the relation
...
ENDFUNCTION
          ...
          ($i_0$, $i_1$, $rs$) is added, the algorithm finds the transitive
          ...
          $NET.Get$($I$, $i_1$), then this new arc between $I$ and $i_1$
          (shown in Figure \ref{figu-tempo-ntwk2}) is again put through the
          same algorithm, as it might yield more relation changes.
...
FUNCTION \(NET.AddRel\)(\(I\sb{0}\), \(I\sb{1}\), \(RS\))
...
ENDFUNCTION
          ...
          \begin{vexample}
            ...
            \begin{vquote}
              $NET.AddRel$($i_0$, $i_1$, \{$BEF$, $MET$, $OVR$\})
            \end{vquote}
            ...
            \begin{figure}[tbhp]
              \begin{center}
                ...
                \caption{Network after $NET.AddRel$($i_0$, $i_1$, \{$BEF$, $MET$, $OVR$\})}
            ...
            arc between interval $i_1$ and interval $i_2$:

            \begin{vquote}
              $NET.AddRel$($i_1$, $i_2$, \{$STA$, $FIN$\})
            \end{vquote}

            \noindent
            The algorithm will also compute the relation set $rs_2$ between
            interval $i_0$ and interval $i_2$ by using the relation set $rs_0$
            between intervals $i_0$ and interval $i_1$, and relation set $rs_1$
            between intervals $i_1$ and interval $i_2$ to complete the
            transitivity. In other words, the algorithm computes the following:
            ...
            \begin{figure}[tbhp]
              \begin{center}
                ...
                \caption{Network after $NET.AddRel$($i_1$, $i_2$, \{$STA$, $FIN$\})}
