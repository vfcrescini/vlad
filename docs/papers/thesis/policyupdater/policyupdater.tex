...
ENDFUNCTION
      ...
      \subsection{Populating the Policy Base}
        ...
        \subsubsection{Registering Entities and Intervals}
          ...
          \begin{valgorithm}[tbhp]{AddEntity()}{algo-impln-adent}
...
ENDFUNCTION
          ...
          \begin{valgorithm}[tbhp]{AddInterval()}{algo-impln-adint}
...
ENDFUNCTION
          ...
          \begin{valgorithm}[tbhp]{AddIntervalEP()}{algo-impln-adine}
...
ENDFUNCTION
        ...
        \subsubsection{Adding Temporal Interval Constraints}
          ...
          \begin{valgorithm}[tbhp]{AddRelation()}{algo-impln-adrel}
...
ENDFUNCTION
        ...
        \subsubsection{Adding Initial State Facts}
          ...
          \begin{valgorithm}[tbhp]{AddInitially()}{algo-impln-adini}
...
ENDFUNCTION
        ...
        \subsubsection{Adding Authorisation Constraints}
          ...
          \begin{valgorithm}[tbhp]{AddConstraint()}{algo-impln-adcon}
...
ENDFUNCTION
        ...
        \subsubsection{Adding Policy Update Declarations}
          ...
          \begin{valgorithm}[tbhp]{AddUpdate()}{algo-impln-adupd}
...
ENDFUNCTION
        ...
        \subsubsection{Policy Update Sequence Manipulation}
          ...
          \begin{valgorithm}[tbhp]{AddSequence()}{algo-impln-adseq}
FUNCTION \(PB\).\(AddSequence\)(\(u\), \(ilist\))
  \(PB\).\(seqtab\).\(Add\)(\(u\), \(ilist\))
ENDFUNCTION
          \end{valgorithm}

          \begin{valgorithm}[tbhp]{DelSequence()}{algo-impln-deseq}
FUNCTION \(PB\).\(DelSequence\)(\(index\))
  \(PB\).\(seqtab\).\(Del\)(\(index\))
ENDFUNCTION
          \end{valgorithm}

          \begin{valgorithm}[tbhp]{ListSequence()}{algo-impln-lsseq}
...
ENDFUNCTION
      ...
      \subsection{Calculating the Answer Set}
        ...
        \begin{valgorithm}[tbhp]{GenAnswerSets()}{algo-impln-genas}
...
ENDFUNCTION
        ...
        \subsubsection{Translating Constraint and Policy Update Rules}
          ...
          \begin{valgorithm}[tbhp]{TransConstRules()}{algo-impln-traco}
...
ENDFUNCTION
          ...
          \begin{valgorithm}[tbhp]{TransUpdateRules()}{algo-impln-traup}
