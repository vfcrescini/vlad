    ...
    FOR \(j\) = \(0\) TO \(Len\)(\(Tu\)) DO
      IF \(Tq\)[\(i\)].\(name\) == \(Tu\)[\(j\)].\(name\) THEN
        ...
        FOR \(k\) = \(0\) TO \(Len\)(\(e\).\(post\)) DO
          \(a\) = \(Encode\)(\(e\).\(post\)[\(k\)].\(atm\), \(i\) + \(1\), \(e\).\(post\)[\(k\)].\(tr\))
          \(RuleHead\)(\(a\), \(T\))
        ENDDO
...
ENDFUNCTION
          ...
          expressions $pre$ and $post$, which corresponds with the $pre$ and
          $post$ fields of the given policy update definition $U$. All
