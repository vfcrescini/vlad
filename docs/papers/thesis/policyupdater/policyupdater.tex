...
\begin{document}
  ...
  relation equals(i0, i1);
      ...
      arcs $i_0$ and $i_1$, we cannot assign the relation {\em finishes} or
      ...
      that algorithms that can ensure full network consistency (e.g.
      {\em k-consistency} \cite{FR}) are intractable. Nevertheless, total
      consistency can easily be checked by employing a simple backtracking
      algorithm. Furthermore, several methods for full network consistency
      checking, like those in \cite{LA,VB} already exist. In this work, we make
      the assumption that 3-consistency is sufficient for our authorisation
      system as we have observed that this covers all scenarios we have
      examined.
