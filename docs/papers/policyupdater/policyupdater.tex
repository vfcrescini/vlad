    ...
    \subsection{Semantics}
      ...
      \subsubsection{Translating Language ${\cal L}$ to Language ${\cal L^{*}}$}
        ...
        \paragraph{Constraint Rules.}
          ...
          of logical rules in language ${\cal L}_{*}$. Each constraint rule
          in language ${\cal L}$ is translated to $\delta$ rules in language
          $\cal{L}^{*}$, where $\delta$ = [number of facts in the always
          clause] $\times$ $\Sigma$.

          Given a constraint in language ${\cal L}$, with $m$ $>$ $0$ and $n$,
          $o$ $\geq$ $0$:
