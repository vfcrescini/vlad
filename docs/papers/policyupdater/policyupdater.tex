      ...
      memb(alice, writers);
        ...
        \paragraph{Additional Constraints.}
          ...
          \subparagraph{Inheritance rules.}
            ...
            A conflic is encountered when a particular property is to be
    ...
    with absence
      ...
      \subsubsection{Translation to Normal Logic Program}
        ...
        \paragraph{Generating the Normal Logic Program from the Policy Base.}
          ...
          and polcy update becomes a set of simple logical rules. By applying
      ...
      \subsubsection{Query Evaluation}
        ...
        by using the stable model semantics with the $smodels$ program. Query
        evaluation then becomes possible by checking whether each fact of a
        given query holds in each generated answer set of the normal logic
        program.
