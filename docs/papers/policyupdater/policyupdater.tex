  ...
  \section{Implementation}
    ...
    \end{figure}
      ...
      \subsubsection{Data Structures}
        ...
        updates must be stored in a buffer structure before the translation
        process is started. This buffer structure is composed of the symbol
        table, the policy base and the policy update sequence.
