    ...
    \subsection{Algorithms}
      ...
      \subsubsection{Translation to Normal Logic Program}
        ...
        \paragraph{Representing Facts in Propositional Form.}
          ...
          The first step in the translation of language ${\cal L}$ to a normal
          logic program is to represent each fact in propositional form.

          Given the symbol table $S$, we first enumerate all atoms derived
          from the entity identifiers defined in the symbol table:
