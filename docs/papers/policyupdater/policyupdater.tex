...
\newenvironment{vquote}
  ...
  {\end{list}}
% create a *smaller* alltt (verbose) environment
...
\begin{document}
  ...
  \footnotetext{
    \tt http://www.cit.uws.edu.au/\~{}jcrescin/
...
update()
  ...
  if
    \(k\sb{0}\) &&\ldots && \(k\sb{w}\) && !\(l\sb{0}\) &&\ldots&& !\(l\sb{x}\)
        ...
        \begin{itemize}
          \item
            $\Upsilon^{+}_{int}$ = \{$a_{z}$ $\mid$ $0$ $\leq$ $z$ $\leq$ $n$\}
          \item
            $\Upsilon^{-}_{int}$ = \{$b_{z}$ $\mid$ $0$ $\leq$ $z$ $\leq$ $m$\}
          \item
            $\Upsilon^{+}_{con}$ = \{$c_{z}$ $\mid$ $0$ $\leq$ $z$ $\leq$ $o$\}
          \item
            $\Upsilon^{-}_{con}$ = \{$d_{z}$ $\mid$ $0$ $\leq$ $z$ $\leq$ $p$\}
          \item
            $\Upsilon^{+}_{upd}$ = \{$i_{z}$ $\mid$ $0$ $\leq$ $z$ $\leq$ $u$\}
          \item
            $\Upsilon^{-}_{upd}$ = \{$j_{z}$ $\mid$ $0$ $\leq$ $z$ $\leq$ $v$\}
        \end{itemize}

        Additionally, we use the complementary notation
        $\overline{\Upsilon}$ to denote a set containing the negation of
        facts of set $\Upsilon$, i.e. $\overline{\Upsilon}$ =
        \{$\lnot\upsilon$ $\mid$ $\upsilon$ $\in$ $\Upsilon$\}.
        ...
        \begin{vdefinition}
          ...
          two ground facts $\delta$ and $\delta'$ are {\bf mutually exclusive} 
          in ${\cal D_{L}}$ if:
          \begin{vquote}
            $\delta$ $\in$ \{$\Upsilon^{+}_{int}$ $\cup$
            $\overline{\Upsilon^{-}_{int}}$ $\cup$ $\Upsilon^{+}_{con}$ $\cup$
            $\overline{\Upsilon^{-}_{con}}$ $\cup$ $\Upsilon^{+}_{upd}$ $\cup$
            $\overline{\Upsilon^{-}_{upd}}$\}

            implies

            $\delta'$ $\not\in$ \{$\Upsilon^{+}_{int}$ $\cup$
            $\overline{\Upsilon^{-}_{int}}$ $\cup$ $\Upsilon^{+}_{con}$ $\cup$
            $\overline{\Upsilon^{-}_{con}}$ $\cup$ $\Upsilon^{+}_{upd}$ $\cup$
            $\overline{\Upsilon^{-}_{upd}}$\}
          \end{vquote}
        ...
        \begin{vdefinition}
          ...
          \begin{enumerate}
            \item
              $\Upsilon^{+}_{int}$ $\cap$ $\Upsilon^{-}_{int}$ = $\emptyset$
            \item
            ...
            \item
              ...
              ${\cal D_{L}}$, there exists a pair of ground expression $\eta$
              $\in$ $\gamma$ and $\eta'$ $\in$ $\gamma'$ such that $\eta$ and
              $\eta'$ are mutually exclusive.
          \end{enumerate}
        \end{vdefinition}
