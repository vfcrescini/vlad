...
\begin{document}
  ...
  \begin{abstract}
    The {\em PolicyUpdater}\footnotemark is a fully-implemented access control
...
query holds(alice, read, file);
  ...
  \makeatletter
  \renewcommand{\@seccntformat}[1]{\appendixname\hspace{0.5em}\csname the#1\endcsname\hspace{1em}}
  \makeatother
