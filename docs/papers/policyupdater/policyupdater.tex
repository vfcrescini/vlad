...
\begin{document}
  ...
  \footnotetext{PolicyUpdater homepage at \\
...
query holds(alice, read, file);
  ...
  \begin{thebibliography}{5}
    ...
    \bibitem{BE2}
      Bertino, E., Mileo A., Provetti, A. [XXX]

    \bibitem{CHO}
      Chomicki, J., Lobo, J., Naqvi S.,
      A Logic Programming Approach to Conflict Resolution in Policy Management.
      In {\em Proceedings of KR2000, 7th International conferece on Principles
    ...
    \bibitem{LOB}
      ...
      In {\em American Association for Artificial Intelligence},
      AAAI-99.
      pp 291-298
      1999
  \end{thebibliography}
