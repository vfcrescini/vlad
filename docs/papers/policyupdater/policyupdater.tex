      ...
      \subsubsection{Symbol Table}
        ...
        \begin{quote}
          \begin{tabular}[t]{|l|l|l|}
            ...
            \hline
            sub\_single & string list & single subject \\
            \hline
            sub\_group & string list & group subject \\
            \hline
            acc\_single & string list & single access \\
            \hline
            acc\_group & string list & group access right \\
            \hline
            obj\_single & string list & single object \\
            \hline
            obj\_group & string list & group object \\
            \hline
          \end{tabular}
        \end{quote}
        ...
        \begin{quote}
          \begin{tabular}[t]{|l|l|l|}
            ...
            \textbf{Field} & \textbf{Type} & \textbf{Description} \\
            \hline
            sub & string list & sub\_single + sub\_group \\
            \hline
            acc & string list & acc\_single + acc\_group \\
            \hline
            obj & string list & obj\_single + obj\_group \\
            \hline
          \end{tabular}
        \end{quote}
