...
query holds(alice, read, comp2);
      ...
      \subsubsection{Domain Description of Language ${\cal L}$}
        ...
        The \emph{domain description} ${\cal D}_{\cal L}$ of language
        ${\cal L}$ is defined to be a finite set of initial state ground facts,
        ground constraint rules and policy update definitions.
