...
\begin{document}
  ...
  \section{Introduction}
    ...
    to logic-based access control systems, e.g. \cite{HAL,LI}. One such system
    was proposed by Bai and Varadharajan \cite{BA1,BA2}. Their system's key
    characteristic is its ability to dynamically update an otherwise static
    policy base.
