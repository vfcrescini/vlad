...
ENDFUNCTION
  ...
  \section{Future Research and Extension}
    ...
    At the time of writing, the authors are working on a new authorisation
    language ${\cal L}^{T}$, an extension of language ${\cal L}$ with
    provisions to (1) express authorisation rules that hold only on specified
    time intervals, and to (2) allow the representation of temporal interval
    relations either under Allen's full interval algebra or one of its
    sub algebras.
