    ...
    \subsection{Semantics}
      ...
      \subsubsection{Language ${\cal L}^{*}$}
        ...
        \paragraph{Atoms.}
          ...
          \begin{quote}
            \begin{math}
              Base(\alpha) = 
              \begin{cases}
                \mbox{\{$s_{\alpha}$, $a_{\alpha}$, $o_{\alpha}$\}, if $\alpha$ is holds} \\
                \mbox{\{$m_{\alpha}$, $g_{\alpha}$\}, if $\alpha$ is memb} \\
                \mbox{\{$g1_{\alpha}$, $g2_{\alpha}$\}, if $\alpha$ is subst}
              \end{cases}
            \end{math}
          \end{quote}
        ...
        \paragraph{Expressions.}
          ...
          facts that may be in different states.
