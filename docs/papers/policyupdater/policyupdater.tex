  ...
  query holds(alice, read, file);
    ...
    \subsection{Semantics}
      ...
      \begin{vdefinition}
        ...
        \begin{enumerate}
          \item
            For any rule of the form $F_{0}$ $\leftarrow$ $F_{1}$,
            $\hdots$, $F_{n}$ where $n$ $>$ 1, if $F_{1}$, $\hdots$,
            $F_{n}$ $\in$ $S$, then
            $F_{0}$ $\in$ $S$.
          \item
        ...
        \begin{enumerate}
          \item
            Each rule that contains a fact of the form $not$ $F$ in its body
            where $F$ $\in$ $S$.
          \item
            All facts of the form $not$ $F$ in the bodies of the remaining
            rules.
        \end{enumerate}
      \end{vdefinition}
