...
query holds(alice, read, file);
    ...
    \subsection{Semantics}
      ...
      \subsubsection{Language ${\cal L}^{*}$}
        ...
        \paragraph{Facts, Expressions and Propositions.}
          ...
          Expressions are conjunctions of facts represented in language
          ${\cal L}_{*}$ as follows:
  ...
  with absence
    !holds(alice, read, secret_data);
          ...
          Given that there are 3 policy update references in the sequence list
          $\psi$ (i.e. $|\psi|$ $=$ $3$), the language ${\cal L}^{*}$
