    ...
    \subsection{Semantics}
      ...
      \subsubsection{State Semantics}
        ...
        \begin{definition}
          ...
          atom represents a logical relationship in a particular state of the
          policy base.
          ...
          \begin{enumerate}
            ...
            \item
              ${\cal A}_{H} = \{\forall (s \in {\cal E}_{S}, a \in {\cal E}_{A}, o \in {\cal E}_{O}, 0 \le \sigma \le |{\cal S}|), holds(s, a, o, \sigma) \}$
            \item
