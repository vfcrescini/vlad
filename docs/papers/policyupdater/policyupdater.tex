...
\begin{document}
  ...
  \section{Introduction}
    ...
    Section \ref{sec-conclusion}, the concluding remarks addresses some
    possible extensions to this system.  Appendix \ref{app-store} shows
      ...
      \subsubsection{Translation to Normal Logic Program}
        ...
        \paragraph{Representing Facts in Propositional Form.}
          ...
          \subparagraph{Arrange the atoms in a predefined order.}
            ...
            enumerated in the following order (from first to last): $holds$,
  ...
  \section{Case Study: Web Server Application}
    ...
    \subsection{Policy Description in Language ${\cal L'}$}
      ...
      \begin{itemize}
        ...
        \item
          {\bf Access Rights} are built in: they are the HTTP request methods
    ...
    \subsection{Mapping the Policies to Language ${\cal L}$}
      ...
      \begin{itemize}
        \item
          {\bf Generating entity identifier definitions}. Subject entities are
        ...
        \item
          {\bf Generating additional constraints}. The module generates
