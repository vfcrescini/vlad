  ...
  \section{Implementation}
    ...
    \end{figure}
      ...
      \subsubsection{Data Structures}
        ...
        policy base. On the other hand, a sequence of policy update directives
        are stored into the update table.
    ...
    with absence
      ...
      \subsubsection{Translation to Normal Logic Program}
        ...
        \paragraph{Representing Facts in Propositional Form.}
          ...
          \subparagraph{Enunmerate all possible atoms.}
          ...
          \subparagraph{Extend indexing procedure to represent facts.} The
            ...
            counterparts, their indices are caclulated by adding $n$ to the
            indices of the correspoding positive facts. Furthermore, this
        ...
        \paragraph{Generating the Normal Logic Program from the Policy Base.}
          ...
          structures (see appendix \ref{app-1}), a normal logic program can
          then be generated for evaluation. By applying the translation rules
          described in the semantics section, and at the same time applying the
          $encode$ function with each fact, a normal logic program is
          generated.
      ...
      \subsubsection{Query Evaluation}
        ...
        in the storage structure, queries can then be evaluated. This is
        accomplished by applying the stable model semantics onto the
        generated normal logic program. By using the $smodels$ progam, a query
        is evaluated by checking whether the query expression holds in each
