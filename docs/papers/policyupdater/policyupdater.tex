...
FUNCTION \(encode\)(\(fact\), \(state\), \(stab\))
  \(h\_off\) =
    (\(stab.ss.len()\) + \(stab.sg.len()\)) \(\times\)
    (\(stab.as.len()\) + \(stab.ag.len()\)) \(\times\)
    (\(stab.os.len()\) + \(stab.og.len()\))
  \(m\_off\) =
    (\(stab.ss.len()\) \(\times\) \(stab.sg.len()\)) +
    (\(stab.as.len()\) \(\times\) \(stab.ag.len()\)) +
    (\(stab.os.len()\) \(\times\) \(stab.og.len()\))
  \(s\_off\) =
    (\(stab.sg.len()\) \(\times\) \(stab.sg.len()\)) +
    (\(stab.ag.len()\) \(\times\) \(stab.ag.len()\)) +
    (\(stab.og.len()\) \(\times\) \(stab.og.len()\))
  ...
  CASE \(fact.type\) OF
    \(holds\) : 
      ...
      \(index\) =
       (\(s\) \(\times\) (\(stab.as.len()\) + \(stab.ag.len()\)) \(\times\)
            (\(stab.os.len()\) + \(stab.og.len()\))) +
       (\(a\) \(\times\) (\(stab.os.len()\) + \(stab.og.len()\))) +
       \(o\)
