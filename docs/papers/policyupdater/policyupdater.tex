  ...
  \section{Language $\cal{L}$}
    ...
    \subsection{Syntax}
      ...
      \subsubsection{Constraint Definition}
        ...
        It is important to note that the expressions $exp1$, $exp2$ and $exp3$
        are non-ground expressions, which means identifiers within them may
        be variables.
...
\end{verbatim}
      ...
      \subsubsection{Query Directive}
        ...
        the update sequence has been applied, one at a time, upon the initial
      ...
      \begin{example}
        ...
        of this program is to ensure that the subject $alice$ is denied $read$
        access to any object in one group if she already holds $read$ to the
        other group.
        ...
        \begin{definition}
          ...
          \begin{quote}
            \begin{math}
              {\cal D}_{\cal L} = 
              \begin{cases}
                \mbox{set of Ground Initial State Facts $\alpha$} \\
                \mbox{set of Ground Constraint Rules $\beta$} \\
