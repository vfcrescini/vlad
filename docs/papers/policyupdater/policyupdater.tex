...
query holds(alice, read, file);
  ...
  \section{Implementation}
          ...
          \subparagraph{Member Atom.}
            \begin{quote}
              \begin{tabular}[t]{|l|l|l|}
                ...
                \textbf{Field} & \textbf{Type} & \textbf{Description} \\
                \hline
                $element$ & string & single entity identifier \\
                \hline
                $group$ & string & group entity identifier \\
                \hline
              \end{tabular}
            \end{quote}
          ...
          \subparagraph{Subset Atom.}
            \begin{quote}
              \begin{tabular}[t]{|l|l|l|}
                ...
                \textbf{Field} & \textbf{Type} & \textbf{Description} \\
                \hline
                $group1$ & string & subgroup entity identifier \\
                \hline
                $group2$ & string & supergroup entity identifier \\
                \hline
              \end{tabular}
            \end{quote}
    ...
    \subsection{Translation to Normal Logic Program}
      ...
      \subsubsection{Grounding of Variables}
        ...
        \begin{quote}
          \begin{tabular}[t]{|l|l|l|}
            ...
            \hline
             ... & ... & ... \\
            \hline
            $st.s[0]$ & $st.acc[len(st.acc)]$ & $st.obj[0]$ \\
            \hline
            ... & ... & ... \\
            \hline
            $st.s[0]$ & $st.acc[len(st.a)]$ & $st.o[len(st.o)]$ \\
            ... & ... & ... \\
            \hline
            $st.s[len(st.sub)]$ & $st.a[0]$ & $st.o[0]$ \\
            \hline
            ... & ... & ... \\
            \hline
            $st.s[len(st.sub)]$ & $st.a[0]$ & $st.o[len(st.o)]$ \\
            \hline
            ... & ... & ... \\
            \hline
            $st.s[len(st.sub)]$ & $st.a[len(st.a)]$ & $st.o[0]$ \\
            \hline
            ... & ... & ... \\
            \hline
            $st.s[len(st.sub)]$ & $st.a[len(st.a)]$ & $st.o[len(st.o)]$ \\
            \hline
          \end{tabular}
        \end{quote}
