...
\begin{document}
  ...
  update()
    ...
    \begin{vquote}
      ...
      \begin{math}
        \begin{cases}
          \mbox{\{$a_{0}$, \ldots, $a_{n}$, $b_{0}$, \ldots, $b_{m}$\}, if $\gamma$ is initially} \\
          \mbox{\{$c_{0}$, \ldots, $c_{o}$, $d_{0}$, \ldots, $d_{p}$\}, if $\gamma$ is constraint} \\
          \mbox{\{$i_{0}$, \ldots, $i_{u}$, $j_{0}$, \ldots, $j_{v}$\}, if $\gamma$ is update}
        \end{cases}
      \end{math}
    \end{vquote}
    ...
    \begin{vquote}
      ...
      \begin{math}
        \begin{cases}
          ...
          \mbox{\{$g_{0}$, \ldots, $g_{s}$, $h_{0}$, \ldots, $h_{t}$\}, if $\gamma$ is constraint} \\
    ...
    \begin{vquote}
      ...
      \begin{math}
        \begin{cases}
          \mbox{$\emptyset$, if $\gamma$ is initially} \\
          \mbox{\{$e_{0}$, \ldots, $e_{q}$, $f_{0}$, \ldots, $f_{r}$\}, if $\gamma$ is constraint} \\
          \mbox{\{$k_{0}$, \ldots, $k_{w}$, $l_{0}$, \ldots, $l_{x}$\}, if $\gamma$ is update}
        \end{cases}
      \end{math}
    \end{vquote}
    ...
    \footnotetext{
      The proof of this theorem is presented in the full version of this paper
      \cite{CRE}.
    }
    ...
    \begin{vdefinition}
      \label{def-eval}
      Given a {\bf consistent} domain description ${\cal D}_{\cal L}$, ground
