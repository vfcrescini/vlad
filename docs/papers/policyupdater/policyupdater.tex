  ...
  \section{Implementation}
    ...
    \subsection{Data Structures}
      ...
      \subsubsection{Entities}
        ...
        All defined entities are sorted among 6 separate string lists:
        ...
        In addition to the above lists, we also define 3 pseudo-lists that are
        concatenations of the above lists:
        ...
        The function $Find$ takes takes an entity identifier $\epsilon$ and an
        entity list $\lambda$ as input parameters and returns the index of
        entity $\epsilon$ with respect to list $\lambda$ or $-1$ if $\epsilon$
        is not in $\lambda$.
