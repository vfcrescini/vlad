      ...
      \subsubsection{Grounding Constraint Variables}
        ...
        \begin{example}
          ...
          \begin{quote}
            \begin{math}
              \begin{aligned}[t]
                holds&(SS0, write, file1) \leftarrow \\
                & holds(SS0, read, file1), \\
                & memb(SS0, students)
              \end{aligned}
            \end{math}
          \end{quote}

          yields the following 3 constraints:

          \begin{quote}
            \begin{math}
              \begin{aligned}[t]
                holds&(alice, write, file1) \leftarrow \\
                & holds(alice, read, file1), \\
                & memb(alice, students) \\
                holds&(bob, write, file1) \leftarrow \\
                & holds(bob, read, file1), \\
                & memb(bob, students) \\
                holds&(charlie, write, file1) \leftarrow \\
                & holds(charlie, read, file1), \\
