  ...
  \section{Language $\cal{L}$}
    ...
    \subsection{Syntax}
      ...
      \subsubsection{Components of Language $\cal{L}$}
        ...
        \noindent{\emph{Identifiers.}} Language $\cal{L}$ consists of
        ...
        \noindent{\emph{Atoms.}} Atoms are composed of a relation plus two or
        ...
        \noindent{\emph{Facts.}} A fact makes a claim that the relationship
        ...
        \noindent{\emph{Expressions.}} An expression is either a fact, or a
