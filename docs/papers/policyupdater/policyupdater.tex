...
\begin{document}
  ...
  \footnotetext{
    PolicyUpdater homepage: {\tt \scriptsize http://www.cit.uws.edu.au/
    \~{}jcrescin/projects/PolicyUpdater/index.html}
  }
  ...
  grant\_write()
    ...
    if memb(alice, writers);
        ...
        description ${\cal D_{L}}$, the language ${\cal L^{*}}$ translation
        ...
        domain $|$$Trans$(${\cal D_{L}}$)$|$ is only polynomially larger
        than the size of the given domain $|$${\cal D_{L}}$$|$. Therefore, from
        a computational viewpoint, computing the answer sets of
