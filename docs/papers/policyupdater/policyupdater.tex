      ...
      \subsubsection{State Semantics}
        ...
        \begin{definition}
          ...
          \begin{enumerate}
            ...
            \item
              ${\cal A}_{H} = \{\forall (s \in {\cal E}_{S}, a \in {\cal E}_{A}, o \in {\cal E}_{O}) \mid holds(s, a, o) \}$
            \item
              ${\cal A}_{M} = {\cal A}_{MS} \cup {\cal A}_{MA} \cup {\cal A}_{MO}$
            \item
              ${\cal A}_{S} = {\cal S}_{SS} \cup {\cal S}_{SA} \cup {\cal A}_{SO}$
            \item
              ${\cal A}_{MS} = \{\forall (e \in {\cal E}_{SS}, g \in {\cal E}_{SG}) \mid memb(e, g)\}$
            \item
              ${\cal A}_{MA} = \{\forall (e \in {\cal E}_{AS}, g \in {\cal E}_{AG}) \mid memb(e, g)\}$
            \item
              ${\cal A}_{MO} = \{\forall (e \in {\cal E}_{OS}, g \in {\cal E}_{OG}) \mid memb(e, g)\}$
            \item
              ${\cal A}_{SS} = \{\forall (g1, g2 \in {\cal E}_{SG}) \mid subst(g1, g2)\}$
            \item
              ${\cal A}_{SA} = \{\forall (g1, g2 \in {\cal E}_{AG}) \mid subst(g1, g2)\}$
            \item
              ${\cal A}_{SO} = \{\forall (g1, g2 \in {\cal E}_{OG}) \mid subst(g1, g2)\}$
          \end{enumerate}
