...
#define VLAD_VLAD_WRAPPER_CAST(X,Y)                                   \
...
#define VLAD_VLAD_WRAPPER_CREATE(X,Y)                                 \
  (((Y) == NULL) ?                                                    \
    VLAD_NULLPTR :                                                    \
    (((*(Y) = VLAD_VLAD_WRAPPER_CAST(VLAD_NEW(X), void *)) == NULL) ? \
      VLAD_MALLOCFAILED :                                             \
      VLAD_OK))
...
{
  return VLAD_VLAD_WRAPPER_CREATE(kb, a_kb);
}
...
VLAD_EXTERN int vlad_kb_add_inittab(void *a_kb, void *a_atm)
{
  ...
  return tmp_kb->add_inittab(VLAD_VLAD_WRAPPER_CAST(a_atm, atom *));
}
                                     ...
                                     void *a_n)
{
  ...
  return tmp_kb->add_consttab(VLAD_VLAD_WRAPPER_CAST(a_e, expression *),
                              VLAD_VLAD_WRAPPER_CAST(a_c, expression *),
                              VLAD_VLAD_WRAPPER_CAST(a_n, expression *));
}
                                     ...
                                     void *a_po)
{
  ...
  return tmp_kb->add_transtab(a_n,
                              VLAD_VLAD_WRAPPER_CAST(a_v, stringlist *),
                              VLAD_VLAD_WRAPPER_CAST(a_pr, expression *),
                              VLAD_VLAD_WRAPPER_CAST(a_po, expression *));
}
...
VLAD_EXTERN int vlad_kb_add_seqtab(void *a_kb, void *a_tr)
{
  ...
  return tmp_kb->add_seqtab(VLAD_VLAD_WRAPPER_CAST(a_tr, transref *));
}
...
{
  return VLAD_VLAD_WRAPPER_CREATE(stringlist, a_slist);
}
...
VLAD_EXTERN int vlad_strlist_destroy(void *a_slist)
{
  ...
  if ((tmp_slist = VLAD_VLAD_WRAPPER_CAST(a_slist, stringlist *)) == NULL)
    return VLAD_INVALIDINPUT;
...
{
  return VLAD_VLAD_WRAPPER_CREATE(atom, a_atm);
}
...
VLAD_EXTERN int vlad_atom_destroy(void *a_atm)
{
  ...
  if ((tmp_atm = VLAD_VLAD_WRAPPER_CAST(a_atm, atom *)) == NULL)
    return VLAD_INVALIDINPUT;
...
{
  return VLAD_VLAD_WRAPPER_CREATE(expression, a_exp);
}
...
VLAD_EXTERN int vlad_exp_destroy(void *a_exp)
{
  ...
  if ((tmp_exp = VLAD_VLAD_WRAPPER_CAST(a_exp, expression *)) == NULL)
    return VLAD_INVALIDINPUT;
...
VLAD_EXTERN int vlad_exp_add(void *a_exp, void *a_atm)
{
  ...
  return tmp_exp->add(VLAD_VLAD_WRAPPER_CAST(a_atm, atom *));
}
...
{
  return VLAD_VLAD_WRAPPER_CREATE(transref, a_tref);
}
...
VLAD_EXTERN int vlad_tref_destroy(void *a_tref)
{
  ...
  if ((tmp_tref = VLAD_VLAD_WRAPPER_CAST(a_tref, transref *)) == NULL)
    return VLAD_INVALIDINPUT;
...
VLAD_EXTERN int vlad_tref_init(void *a_tref, const char *a_n, void *a_slist)
{
  ...
  return tmp_tref->init(a_n, VLAD_VLAD_WRAPPER_CAST(a_slist, stringlist *));
}

/* create a consttab */
VLAD_EXTERN int vlad_consttab_create(void **a_ct)
{
  return VLAD_VLAD_WRAPPER_CREATE(consttab, a_ct);
}
...
VLAD_EXTERN int vlad_consttab_destroy(void *a_ct)
{
  ...
  if ((tmp_ct = VLAD_VLAD_WRAPPER_CAST(a_ct, consttab *)) == NULL)
    return VLAD_INVALIDINPUT;
...
VLAD_EXTERN int vlad_consttab_add(void *a_ct, void *a_e, void *a_c, void *a_n)
{
  ...
  return tmp_ct->add(VLAD_VLAD_WRAPPER_CAST(a_e, expression *),
                     VLAD_VLAD_WRAPPER_CAST(a_c, expression *),
                     VLAD_VLAD_WRAPPER_CAST(a_n, expression *));
}
...
VLAD_EXTERN int vlad_list_length(void *a_list)
{
  ...
  if ((tmp_list = VLAD_VLAD_WRAPPER_CAST(a_list, list *)) == NULL)
    return 0;
